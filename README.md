...
This project is an interactive Sales Analysis Dashboard built using Power BI to analyze sales performance, product trends, and customer insights.
It provides a complete business view through multiple dashboards with dynamic filtering and visual analytics.
...
✅ Drill-down and hover insights (Tooltips)
✅ Clean and consistent UI design
✅ Multi-page navigation (Introduction, Sales, Product, Customer, Tooltip)
...
This project demonstrates how raw data can be transformed into meaningful business insights using Power BI. It helps stakeholders make data-driven decisions efficiently.
